/*++----------------------------------------------------------------------------------------------------------------------------------------------------------------------
1. 项目名称：ares
2. 文件名：src -> application -> controllers -> trend -> esf -> sold-history -> renderer.js
...
class Renderer extends AppRendererControllerBasic {
    ...
    async renders(){
        ...
        let modulePathArray = [ "trend" , "esf" , "sold-history" ] ;
        let apiPathArray = [ "trend" , "esf" , "historicalTransactionList" ] ;
        try{
            /*++-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
            调用接口获取数据
            -----------------------------------------------------------------------------------------------------------------------------------------------------------------------++*/
            let adf = new ApiDataFilter(this.req.app);
            let regionId  = this.req.params.regionId ; //板块Id
